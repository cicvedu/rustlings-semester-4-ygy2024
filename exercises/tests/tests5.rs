...
unsafe fn modify_by_address(address: usize) {
    ...
    unsafe {
        // We must ensure that the address is valid and points to a u32.
        // We cast the address back to a *mut u32 and then dereference it.
        // We assume that the caller has ensured the address is correct and valid.
        // The responsibility of proving this function's safety lies with the caller.
