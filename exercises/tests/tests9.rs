...
mod Foo {
    // Define the function with the `#[no_mangle]` attribute to prevent mangling.
    #[no_mangle]
    pub fn my_demo_function(a: u32) -> u32 {
        a
    }

    // Define an alias for `my_demo_function` inside the Foo module.
...
mod tests {
    ...
    #[test]
    fn test_success() {
        // Since we're calling a safe Rust function, we don't need to use `unsafe`.
